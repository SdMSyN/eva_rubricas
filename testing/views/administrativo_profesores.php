    ...
    if (isset($_SESSION['sessU']) AND $_SESSION['userPerfil'] == 2) {
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="row">
                    ...
                    <div class="col-xs-5 ">
                        <div class="btn-group pull-right">
                            <a href="#" class="btn btn-default" data-toggle="modal" data-target="#modalAddProf"><i class="fa fa-plus"></i> Nuevo</a>
                ...
                <!-- modal añadir nuevo profesor -->
                <form class="form-horizontal" id="formAddProf" name="formAddProf">
                                    ...
                                    <table class="table table-striped table-bordered" id="data">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><span title="estado_id">Estado</span></th>
                                                <th>Acciones</th>
                                            </tr>
                                        </thead>
                                        <tbody></tbody>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $("#data").on("click", "#borrar", function () {
                    ...
                    var msgBorrar = '';
                    if (idEdo == 1)
                        msgBorrar = "¿Seguro que deseas dar de baja a este profesor?";
                    else
                        msgBorrar = "¿Seguro que deseas dar de alta a este profesor?";
