  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
			<div class="row">
				...
				<div class="col-xs-5 ">
					<div class="btn-group pull-right">
						<a href="#" class="btn btn-default" data-toggle="modal" data-target="#modalAddPlanEst"><i class="fa fa-plus"></i> Nuevo</a>
			...
			<!-- modal añadir nuevo plan de estudios -->
				<form class="form-horizontal" id="formAddPlanEst" name="formAddPlanEst">
					<div class="modal fade" id="modalAddPlanEst" tabindex="-1" role="dialog" aria-labellebdy="myModalLabel">
				...
				<div class="col-md-12">
					<div class="box">
						<div class="box-header with-border">
							<h3 class="box-title">Listado de Planes de Estudio</h3>
